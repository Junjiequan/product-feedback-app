        ...
        <A.Wrapper>
            ...
            <A.Form>
                <A.InputWrapper>
                    ...
                    <A.Input maxLength={50} placeholder="Max 50 characters" required/>
                </A.InputWrapper>
                <A.InputWrapper>
                ...
                <A.InputWrapper>
                    ...
                    <A.Textarea maxLength={225} rows={3} placeholder="Max 225 characters" required/>
                </A.InputWrapper>
                <A.ButtonWrapper>
                    <FeedBackLinkDarkBlue to="/" data-space-right={true} data-text="Cancel" aria-label="back to homepage"/>
                    <FeedBackBtnPurple data-text="Add Feedback" aria-label="create new feedback"/>
                </A.ButtonWrapper>
            </A.Form>
        </A.Wrapper>
    )
